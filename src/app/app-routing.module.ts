...
const routes: Routes = [
  ...
  { path: 'editarGenerico/:id', component: P006CrearGenericoComponent, canActivate: [CanActivateUser] },
  { path: 'nuevaPantalla/:id', component: P007CrearPantallaComponent, canActivate: [CanActivateUser] },
  { path: 'editarPantalla/:id', component: P007CrearPantallaComponent, canActivate: [CanActivateUser] },
  { path: 'nuevoVisual/:id', component: P008CrearVisualComponent, canActivate: [CanActivateUser] },
  { path: 'editarVisual/:id', component: P008CrearVisualComponent, canActivate: [CanActivateUser] },
